...
```
## Implementation Review Findings - Pass [N]
...
### Next Steps
After exiting plan mode, run `/review-impl` again to apply fixes automatically.
```
...
Review the plan. After exiting plan mode, run /review-impl again to apply fixes.
```
